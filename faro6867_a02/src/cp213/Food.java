...
public class Food implements Comparable<Food> {
	...
	public int compareTo(final Food target) {
		...
		// your code here
		int n = name.compareTo(target.name);
		if (n == 0) {
			n = Integer.compare(origin, target.origin);
		}
	...
	public void write(final PrintStream ps) {
		...
		// your code here
		String foodz = String.format("%s|%d|%b|%d", name, origin, isVegetarian, calories);
		ps.println(foodz);
